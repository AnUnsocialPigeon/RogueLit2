...
namespace RogueLit2.Classes.Controllers {
    internal class AudioController {
        private Dictionary<SFX, string> SFXLocation = new() {
            ...
            { SFX.Drama1, Directory.GetCurrentDirectory() + @"\Assets\Other\Dramatic_Hit_Intense_01.wav" },
            { SFX.Drama2, Directory.GetCurrentDirectory() + @"\Assets\Other\Dramatic_Hit_Intense_02.wav" },
            { SFX.Drama3, Directory.GetCurrentDirectory() + @"\Assets\Other\Dramatic_Hit_Intense_03.wav" },
            { SFX.Drama4, Directory.GetCurrentDirectory() + @"\Assets\Other\Dramatic_Hit_Intense_04.wav" },
            { SFX.Drama5, Directory.GetCurrentDirectory() + @"\Assets\Other\Dramatic_Hit_Intense_05.wav" },
            ...
            { SFX.Heartbeat1, Directory.GetCurrentDirectory() + @"\Assets\PlayerandPickAxe/70_Heart_Beat_Fluctuating.wav" },
            ...
            { SFX.Chew1, Directory.GetCurrentDirectory() + @"\Assets\Creature\Monster_Eat_Chew.wav" },
            ...
            { SFX.Whoosh2, Directory.GetCurrentDirectory() + @"\Assets\Creature\Reverse_Surreal_Breaths_03.wav" },
